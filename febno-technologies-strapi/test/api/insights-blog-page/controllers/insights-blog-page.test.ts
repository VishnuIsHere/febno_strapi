import controllerFactory from '../../../../src/api/insights-blog-page/controllers/insights-blog-page';
...
describe('insights-blog-page controller', () => {
    it('should format bullets in LatestBlogsSection cards', async () => {
        ...
        expect(response.data.attributes.LatestBlogsSection.cards).toEqual([
    ...
    it('should handle response with data but missing cards gracefully', async () => {
        ...
        expect(response.data.attributes.LatestBlogsSection).toEqual({});
    });
});
